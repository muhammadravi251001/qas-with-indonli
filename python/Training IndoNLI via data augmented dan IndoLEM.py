if __name__ == '__main__':
    ...
    # Uncomment this code if you don't have dev_augmented.jsonl & train_augmented.jsonl
    #get_ipython().system('wget https://huggingface.co/datasets/muhammadravi251001/augmented-indo-nli/raw/main/dev_augmented.jsonl')
    #get_ipython().system('wget https://huggingface.co/datasets/muhammadravi251001/augmented-indo-nli/resolve/main/train_augmented.jsonl')
