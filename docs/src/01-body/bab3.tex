...
\end{itemize}
    ...
    \item Sebagai catatan, pada penelitian ini, penulis hanya akan bereksperimen dengan tipe \emph{filtering} dan tipe perubahan format jawaban. Sehingga untuk jumlah iterasi maksimum diatur selalu bernilai 2, variasi pengambilan jawaban final diatur selalu variasi 1, dan \emph{threshold} diatur selalu bernilai 0.5.
